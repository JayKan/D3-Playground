;(function () {
  ...
  // Generate a tree layout with height and width
  var tree = d3.layout.tree()
    .size([height, width]);

  // Create a new diagonal generator for creating curved lines
  ...
  function update(source) {
    ...
    // Add node's last and first name
    g.append('text')
    ...
    // Transition node to their new positions
    ...
    // Fill node's circle with profile picture
